...
const api = {
  ...
  listInis: () => ipcRenderer.invoke(IPC.listInis),
  readIni: (id: number) => ipcRenderer.invoke(IPC.readIni, id),
  writeIni: (id: number, values: Record<string, string>) => ipcRenderer.invoke(IPC.writeIni, id, values),
  setActiveIni: (id: number) => ipcRenderer.invoke(IPC.setActiveIni, id),
  musicStatus: () => ipcRenderer.invoke(IPC.musicStatus),
  musicPlaylists: () => ipcRenderer.invoke(IPC.musicPlaylists),
  musicPlay: () => ipcRenderer.invoke(IPC.musicPlay),
  musicStop: () => ipcRenderer.invoke(IPC.musicStop),
  musicNext: () => ipcRenderer.invoke(IPC.musicNext),
  musicPlayback: (type: string) => ipcRenderer.invoke(IPC.musicPlayback, type),
  musicSetPlaylist: (name: string) => ipcRenderer.invoke(IPC.musicSetPlaylist, name),
  ...
  downloadFile: (path: string, suggestedName: string) =>
    ipcRenderer.invoke(IPC.downloadFile, path, suggestedName),
  uploadFiles: (dir: string) => ipcRenderer.invoke(IPC.uploadFiles, dir),
  backupSaves: () => ipcRenderer.invoke(IPC.backupSaves),
